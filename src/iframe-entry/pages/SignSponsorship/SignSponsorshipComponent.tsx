            ...
            <TabPanels bg="main.$800" mb="$30" px="$40">
                <TabPanel>
                    ...
                    >
                        ...
                        <Text color="standard.$0" variant="body2" mb="$20">
                            {sponsorCharge}
                        </Text>
                        ...
                        {isSponsorshipEnable && (
                            <Flex
                                ...
                                borderRadius="$4"
                            >
                                <Text color="#ffaf00" variant="body1" mb="$5">
                                    Users will be able to pay transaction fees
                                    in {sponsorAsset.name}
                                </Text>
                                <Text color="basic.$300" variant="body2">
                                    For each transaction, 0.001 WAVES will be
                                    deducted from your balance and{' '}
                                    {sponsorAsset.name} will be credited to your
                                    account. If you have the script account you
                                    will be cost 0.001 + 0.004 WAVES. The amount
                                    of {sponsorAsset.name} to be charged to
                                    users for transactions is set by you when
                                    you enable Sponsorship (enter the amount in
                                    the form above). Sponsorship will only work
                                    if you have a balance of at least 1.005
                                    WAVES. If your balance falls below this
                                    amount, you will be unable to sponsor
                                    transactions.
                                </Text>
                            </Flex>
                        )}
