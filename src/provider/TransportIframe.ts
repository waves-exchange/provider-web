...
export class TransportIframe implements ITransport {
    ...
    constructor(url: string, cacheKill: boolean) {
        ...
        this._ready = WindowAdapter.createSimpleWindowAdapter(this._iframe).then(adapter => {
            this._hideIframe();
    ...
    private static _createIframe(url: string, cacheKill: boolean): HTMLIFrameElement {
