...
export default withTheme(
    class Login extends Component<TProps, TState> {
        ...
        public render() {
            ...
            return (
                <Modal>
                    ...
                    <Flex justifyContent="center" mb="10px">
                        <Text fontSize="15px" color="white" fontFamily="Roboto">
                    ...
                    >
                        <Text color="#fff">
                            Don't worry! The dApp won't have access to your
                            tokens, seed phrases or passwords. They are stored
                            locally within your browser.
                        </Text>
                    </Box>
                    {Boolean(state.users.length) === false ? (
                        <Fragment>
        ...
        private readonly onChangeUser = (e: any) => {
            // TODO
            this.setState({
        ...
        private readonly onEnterPassword = () => {
            const state = this.state;
            const encryptedData = localStorage.getItem('multiAccountData');
            const json =
                encryptedData != null
                    ? decrypt(encryptedData, state.password)
                    : null;
        ...
        private readonly onKeyPress = (e: any) => {
            // TODO
            if (e.code === 'Enter') {
        ...
        private readonly onConfirm = () => {
            this.props.onConfirm(
                this.state.users.find(
                    (item) => item.address === this.state.activeUser
                )!
            );
        };
    }
